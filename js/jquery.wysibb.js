...
//			direction:			"ltr",
			...
			smileList: [
				{title:"", img: '<img src="/img/wysibb/smiles/smile.gif" class="sm">', bbcode:":)"},
				{title:"", img: '<img src="/img/wysibb/smiles/sad.gif" class="sm">', bbcode:":("},
				{title:"", img: '<img src="/img/wysibb/smiles/biggrin.gif" class="sm">', bbcode:":D"},
				{title:"", img: '<img src="/img/wysibb/smiles/wink.gif" class="sm">', bbcode:";)"},
				{title:"", img: '<img src="/img/wysibb/smiles/good.gif" class="sm">', bbcode:":good:"},
				{title:"", img: '<img src="/img/wysibb/smiles/bad.gif" class="sm">', bbcode:":bad:"},
				{title:"", img: '<img src="/img/wysibb/smiles/chok.gif" class="sm">', bbcode:":shock:"},
				{title:"", img: '<img src="/img/wysibb/smiles/aggressive.gif" class="sm">', bbcode:":angry:"},
				{title:"", img: '<img src="/img/wysibb/smiles/bo.gif" class="sm">', bbcode:":bo:"},
				{title:"", img: '<img src="/img/wysibb/smiles/lol.gif" class="sm">', bbcode:":lol:"},
				{title:"", img: '<img src="/img/wysibb/smiles/kiss.gif" class="sm">', bbcode:":kiss:"},
				{title:"", img: '<img src="/img/wysibb/smiles/rofl.gif" class="sm">', bbcode:":rofl:"}
			],
		...
		buildToolbar: function() {
			...
			if (this.options.onlyBBmode===false) {
				$bbsw.children(".wysibb-toolbar-btn").click($.proxy(function(e) {
					...
					this.$txtArea.toggleClass("showbbcode");
					this.modeSwitch();
				},this));
			}
		...
		imgLoadModal: function() {
			...
			if (this.options.imgupload===true) {
				...
				this.$modal.find("#fupform").bind("submit",$.proxy(function(e) {
					$(e.target).parents("#imguploader").hide().after('<div class="loader"><img src="/img/wysibb/loader.gif" /><br/><span>'+CURLANG.loading+'</span></div>').parent().css("text-align","center");
				},this))
