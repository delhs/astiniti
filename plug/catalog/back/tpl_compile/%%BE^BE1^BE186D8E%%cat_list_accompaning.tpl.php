<?php /* Smarty version 2.6.27, created on 2014-02-10 18:02:02
         compiled from cat_list_accompaning.tpl */ ?>
<div class="plug_catalog categories">
	<div class="cat_list">
	<?php if (! isset ( $this->_tpl_vars['cat_not_exists'] )): ?>
		<p>Выберите нужную категорию, кликнув по ней, а затем, щелкните по товарам, которые будут являться сопутствующими</p>
		<div class="form">
