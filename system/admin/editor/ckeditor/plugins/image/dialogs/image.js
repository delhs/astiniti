        ...
        return {
                    ...
                    if (1 == c.count()) {
                        ...
                        if ("img" == g || "input" == g)
                            this.imageElement = c.getItem(0), "img" == this.imageElement.getName() ?
                                this.imageEditMode = "img" : "input" == this.imageElement.getName() && (this.imageEditMode = "input")
                    }
                    "image" == j &&
            ...
            onOk: function () {
                if (this.imageEditMode) {
                    ...
                    "image" == j && "input" == a && confirm(c.lang.image.button2Img) ? (this.imageElement = c.document.createElement("img"), this.imageElement.setAttribute("alt", ""),
                        c.insertElement(this.imageElement)) : "image" != j && "img" == a && confirm(c.lang.image.img2Button) ? (this.imageElement = c.document.createElement("input"),
            ...
            contents: [{
                ...
                }, 
                {
                    ...
                    style: "width : 15px;",
                    label: c.lang.image.fancy,
                    "default": "",
                    items: [
                        [c.lang.image.fancyNo, "off"],
                        [c.lang.image.fancyYes, "on"]
                    ],
                    setup: function (a, b) {
                        if(a==f && b.getAttribute("data-fancy")!=null) this.setValue("true");
                    },
                    commit: function (a, b) {
                        if(a==f){
                            if( this.getValue() ){
                                b.setAttribute("data-fancy", "on");
                            }else{
                                b.removeAttribute("data-fancy");
                            }
                        }
                    } 
                },
